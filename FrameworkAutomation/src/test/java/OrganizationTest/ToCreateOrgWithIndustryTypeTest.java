...
@Test(groups="Regression")
	public void ToCreateOrgWithIndustryType_001() throws EncryptedDocumentException, IOException {
		...
		weutil.toHandleDropdown(industryDropDown, "Energy");
		WebElement typedropdown = cop.getType();
		weutil.toHandleDropdown(typedropdown, "Customer");
		cop.getSave().click();
		//Fail
		//Assert.fail();
